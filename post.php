...
<section>
  ...
  <h2 class="text-center title"><?=$judul; ?></h2>
    <img src="gambar/blog/<?=$image;?>" alt="..." width="360" height="124">
    <div class="caption">
   <h5><span class="glyphicon glyphicon-time"></span> Post by Jane Dane, <?=$waktu; ?></h5>
...
<div class="media-left">
  <a href="#">
    <img class="media-object" src="gambar/profile.jpg" alt="foto profil" height="64px" width="64px">
  </a>
</div>
...
<!-- Search Widget -->
  ...
  <div class="media">
  <div class="media-body">
    <h4 class="media-heading" style="padding-top:25px;"> <?php echo $no.'. '. excerpt_popular ($row['judul']); ?></h4>
  </div>
   <div class="media-right">
    <a href="#">
      <img class="media-object" src="gambar/blog/<?php echo $row['gambar']; ?>" alt="foto profil" height="64px" width="64px">
    </a>
  </div>
  </div>
