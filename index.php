...
<section>
 ...
 <?php while ($row= mysqli_fetch_assoc ($result)): ?>
  <div class="col-md-6">
  <div class="thumbnail">
    <img src="gambar/blog/<?php echo $row['gambar']?>" alt="..." width="360" height="124">
    <div class="caption">
      <h2><?php echo $row['judul']; ?></h2>
   <h5><span class="glyphicon glyphicon-time"></span> Post by admin, <?php echo $row['waktu'];?></h5>
    <h5><span class="label label-danger"><?php echo excerpt_judul ($row['judul_tag']);?></span> </h5><br>
